            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title"><?=!empty($ispanel) ? _dp("Translation of Panel") : _dp("Website Çeviri") ?></h4>
                    ...
                    <div class="card-body -vB">
                        ...
                        <button form="ldform" type="submit" class="btn btn-primary pull-right float-right ldFormSubmit js-ldFormSubmit" data-mode="">
                            <span class="cedit__submitbtnNormal ldFormSubmitNormal"><?=_dp("SAVE")?></span>
